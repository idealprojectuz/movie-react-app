...
class App extends Component {
	constructor(props) {
		...
		this.state = {
			data: [
				{ name: 'Harry Potter', viewers: 988, favourite: false, like: false, id: 1 },
				{ name: 'Sevgi iztirobi', viewers: 789, favourite: false, like: false, id: 2 },
				{ name: 'lutsifer', viewers: 1091, favourite: false, like: false, id: 3 },
			],
			term: '',
			filter: 'all',
		}
